                        ...
                        <div class="col-xl-3">
                            <div class="input-group w-100 mx-auto d-flex">
                                <form id="searchForm" style="display: flex">
                                    <input type="search" name="search" class="form-control p-3" placeholder="keywords" aria-describedby="search-icon-1" value="${param.keyword}">

                                <span id="search-icon-1" class="input-group-text p-3" onclick="submitForm()"><i class="fa fa-search"></i></span>
                            </form>
                    ...
                    <div class="col-lg-3">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <c:forEach var="fruit1" items="${requestScope.fruits}" varStatus="loop">
...
<script>
    function submitForm() {
        ...
        // Set the action attribute dynamically (optional, if needed)
        form.action = "search";
        form.method = "get";
